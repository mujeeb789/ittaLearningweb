...
function Team() {
  return (
    <>
      {/* About Section */}
      <About />
      <main className="flex flex-col items-center justify-center w-full px-4 lg:px-0">
        {teams.map((team, index) => {
          return (
            ...
            <div
              key={index}
              className="flex flex-col lg:flex-row items-center justify-center bg-slate-200 shadow-lg rounded-lg overflow-hidden p-6 lg:p-8 mb-10 w-full max-w-4xl"
            >
              {/* Image Section */}
              ...
              <div className="lg:w-2/3 flex flex-col items-center lg:items-start text-center lg:text-left p-4 lg:p-6">
